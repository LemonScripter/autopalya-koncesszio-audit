...
3. **Kúria mint felülvizsgálati bíróság:** **`Kúria Pfv.IV.21.194/2023/15.`** számú ítélet (dátum: **2024. március 13.**; közzétételi azonosító: `K-PJ-2024-94`).
   * **Rendelkező rész:** A Kúria a jogerős másodfokú ítélet felülvizsgálattal támadott rendelkezését **hatályában fenntartotta**. Kötelezte az alperest és a beavatkozót perköltség megfizetésére. Felülvizsgálatnak helye nincs.
4. **Alkotmánybíróság (AB):** **`3372/2024. (X. 8.) AB végzés`** (ügyszám: **`IV/1946/2024`**; testületi ülés: 2024. szeptember 24.).
   * Az MKIF Zrt. által benyújtott 18 oldalas alkotmányjogi panaszt (amely a tisztességes eljárás, a bírói indokolás és a szakértői bizonyítás mellőzése miatti alapjogsérelmekre hivatkozott) az Alkotmánybíróság **visszautasította**.
...
* **3/A. és 3/B. számú mellékletek:** A Rendelkezésre állási díj (RÁD) és Szolgáltatási díj (RÁASZD) díjszámítási metódusa, levonási tényezői és teljesítményi pontrendszere.
* **3/C. számú melléklet:** A számlázási feltételek (tört fizetési hónapok kezelése, útszakaszonkénti bontás, devizanemek, alkalmazandó árfolyamok).
* **3/D. számú melléklet:** A rendelkezésre nem állási események definíciói, minimális útburkolati követelmények, kimentett események és forgalomkorlátozások rendszere.
* **3/E. számú melléklet:** Az egyes útszakaszokra és évekre lebontott konkrét RÁD és RÁASZD díjtételek (kitakarás nélkül).
* **8/B. számú melléklet:** További részletes műszaki követelmények és paraméterek.
* **10. számú melléklet:** Térítési mechanizmus felmondás vagy részleges lehetetlenülés esetére.
* **14. számú melléklet:** Szerződéses elválaszthatatlan háttérdokumentumok: felhívások, tájékoztatások, térképek, várható projektek listája.
* **15. számú melléklet:** A nyertes koncesszor ajánlata és pénzügyi modellje (benne az Ajánlat II. kötet 120–179. oldalain található részletes költség-, bevétel- és tőkestruktúra táblázatok, kitakarás nélkül).
* **23. számú melléklet:** Egyéb szerződéses melléklet.
...
* **A közérdekűségi teszt:** A közérdekű adat nyilvánossága a főszabály; a korlátozás kivételes. A megtagadási ok (üzleti titok) fennállását és annak jogszerűségét az adatkezelő és a titokgazda köteles bizonyítani.
...
| :--- | :---: | :--- | :--- |
| **Kúria `Pfv.IV.21.194/2023/15.`** *(K-PJ-2024-94)* | 2024. 03. 13. | Újságíró vs. NKOI (MKIF beavatkozó) | **Autópálya-koncessziós szerződés.** A 11 pénzügyi-műszaki melléklet kiadását elrendelő jogerős ítéletet hatályában fenntartotta. A szakértői bizonyítás mellőzése jogszerű, a RÁD-számítások és az ajánlati pénzügyi táblázatok nyilvánosak. |
| **Fővárosi Ítélőtábla `2.Pf.20.469/2023/9/I.`** | 2023. 10. 17. | Újságíró vs. NKOI (MKIF beavatkozó) | **Autópálya-koncessziós szerződés.** Jogerős másodfokú ítélet: a 3/E. és 15. melléklet táblázatai kitakarás nélkül kiadandók. |
| **Fővárosi Törvényszék `25.P.21.778/2023/18.`** | 2023. 07. 18. | Újságíró vs. NKOI (MKIF beavatkozó) | **Autópálya-koncessziós szerződés.** Megismételt elsőfokú ítélet: elutasította az MKIF szakértői bizonyítási indítványát (`25.P.21.778/2023/10.`). |
| **Alkotmánybíróság `3372/2024. (X. 8.) AB végzés`** *(IV/1946/2024)* | 2024. 09. 24. | MKIF Zrt. panaszos vs. Kúria | **Autópálya-koncessziós szerződés.** Az MKIF alkotmányjogi panaszát visszautasította; a bírósági eljárás nem sértette az Alaptörvényt. |
| **Kúria `Pfv.IV.21.124/2023/16.`** *(Kapcsolódó elvi döntés)* | 2024. 02. 14. | TI Magyarország vs. Miniszterelnöki Kabinetiroda / NKOI (MOL beavatkozó) | **MOL hulladékgazdálkodási koncesszió.** Elvi döntés az Infotv. 27. § (3) bekezdéséről: a verseny tisztaságára hivatkozva a lezárt tender után a közpénzes szerződés nem titkosítható. |
