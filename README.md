# 🛣️ Magyar Gyorsforgalmi Úthálózat Koncessziós Audit
...
flowchart TD
    ...
    subgraph Output["3. Reprodukálható Eredmények & Ellenőrzés"]
        direction TB
...
│   ├── 05_Kuria_es_Birosagi_Iteletek/      # Kúria és Alkotmánybírósági döntések
